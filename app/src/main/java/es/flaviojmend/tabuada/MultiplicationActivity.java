...
public class MultiplicationActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public static final int SUM_MAX_LIMIT = MAX_LIMIT * MAX_LIMIT;
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.result_popup:
                Intent intentNext = new Intent(this, MultiplicationActivity.class);
    ...
    private void evaluateResult(RelativeLayout view, HandwrittenTextView txtResult, ImageView imgResult) {
        ...
        if(value == result) {
            ...
            int multiplicationsRight = preferences.getInt(PontuationModel.multiplicationsRight, 0);
            multiplicationsRight += 1;

            SharedPreferences.Editor editor = preferences.edit();
            editor.putInt(PontuationModel.multiplicationsRight, multiplicationsRight);
            editor.apply();
            ...
            int multiplicationsWrong = preferences.getInt(PontuationModel.multiplicationsWrong, 0);
            multiplicationsWrong += 1;
