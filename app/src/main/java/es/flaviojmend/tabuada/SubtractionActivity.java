...
public class SubtractionActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        num2 = ThreadLocalRandom.current().nextInt(MIN_LIMIT, num1);
        result = num1 - num2;
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.result_popup:
                Intent intentNext = new Intent(this, SubtractionActivity.class);
    ...
    private void evaluateResult(RelativeLayout view, HandwrittenTextView txtResult, ImageView imgResult) {
        ...
        if(value == result) {
            ...
            int subtractionsRight = preferences.getInt(PontuationModel.subtractionsRight, 0);
            subtractionsRight += 1;

            SharedPreferences.Editor editor = preferences.edit();
            editor.putInt(PontuationModel.subtractionsRight, subtractionsRight);
            editor.apply();
            ...
            int subtractionsWrong = preferences.getInt(PontuationModel.subtractionsWrong, 0);
            subtractionsWrong += 1;
